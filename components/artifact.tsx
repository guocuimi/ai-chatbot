...
function PureArtifact({
  ...
  } = useSWR<Array<Document>>(artifact.documentId !== 'init' && artifact.status !== 'streaming' ? `/api/document?id=${artifact.documentId}` : null, fetcher)
      ...
      {artifact.isVisible && (
        ...
        >
          ...
          >
            ...
            <AnimatePresence>
              {!isCurrentVersion && <VersionFooter currentVersionIndex={currentVersionIndex} documents={documents} handleVersionChange={handleVersionChange} />}
            </AnimatePresence>
          </motion.div>
        </motion.div>
      )}
