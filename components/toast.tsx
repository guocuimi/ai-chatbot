  ...
  return (
    <div className="toast-mobile:w-[356px] flex w-full justify-center">
      <div
        data-testid="toast"
        key={id}
        className={cn('toast-mobile:w-fit flex w-full flex-row gap-3 rounded-lg bg-zinc-100 p-3', multiLine ? 'items-start' : 'items-center')}
      >
        <div data-type={type} className={cn('data-[type=error]:text-red-600 data-[type=success]:text-green-600', { 'pt-1': multiLine })}>
          {iconsByType[type]}
        </div>
